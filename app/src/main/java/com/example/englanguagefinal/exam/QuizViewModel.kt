...
class QuizViewModel(var context: Context) : ViewModel() {
    ...
    fun addDataConferences() {
        job = CoroutineScope(Dispatchers.IO + exceptionHandler).launch {
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("Phù hợp?", "Accommodate", "Assurance", "Association", "Address", 1, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
    ...
    fun addDataCorrespondence() {
        job = CoroutineScope(Dispatchers.IO + exceptionHandler).launch {
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("Thư từ, quan hệ thư từ?", "Correspondence", "assemble", "Arrangement", "Abide by", 1, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("thu thập, tập hợp?", "beforehand", "Association", "assemble", "Correspondence", 3, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("sẵn, có sẵn, trước, sớm?", "complication", "beforehand", "assemble", "Correspondence", 2, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("sự phức tạp?", "beforehand", "Association", "assemble", "complication", 4, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("người đưa thư, chuyển phát?", "courier", "Association", "Allocate", "express", 1, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("tốc hành, nhanh, hỏa tốc?", "courier", "express", "Allocate", "express", 2, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("gấp, gập?", "fold", "courier", "Arrangement", "express", 1, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("sự bố trí, trang trí giấy?", "courier", "fold", "layout", "express", 3, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("sự kiến nghị?", "express", "fold", "layout ", "petition", 4, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("đề cập?", "express", "fold", "layout ", "mention", 4, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("tìm lỗi, kiểm lỗi (v)?", "express", "mention", "proof", "layout", 3, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("bằng chứng, chứng cớ (n)?", "express", "proof", "layout ", "mention", 2, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("sửa lại?", "revise", "proof", "layout ", "mention", 1, ""))
        }
    }
    fun addDataJob() {
        job = CoroutineScope(Dispatchers.IO + exceptionHandler).launch {
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("nhiều, phong phú, thừa?", "Abundant", "Association", "accomplish", "accomplishment", 1, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("hoàn thành?", "Access", "accomplishment", "accomplish", "Abundant", 3, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("thành tựu, thành tích?", "Access", "accomplishment", "accomplish", "Abundant", 2, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("tập hợp lại/ gia nhập?", "accomplish", "Abundant", "Arrangement", "bring together", 4, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("ứng viên?", "Candidate", "Association", "Allocate", "Abide by", 1, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("đưa ra ý định?", "Candidate", "come up with", "Allocate", "bring together", 2, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("tương xứng với?", "Commensurate", "Association", "Arrangement", "bring together", 1, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("sự tương xứng, thích hợp?", "Access", "Candidate", "match", "come up with", 3, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("hồ sơ, tiểu sử?", "Accommodate", "Commensurate", "match", "profile", 4, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("tư cách, năng lực (để làm cái gì)?", "Consequence", "Commensurate", "profile", "qualification", 4, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("tuyển dụng?", "Access", "Candidate", "recruit", "bring together", 3, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("nộp, trình, đệ trình (đơn)?", "Candidate", "submit", "Arrangement", "come up with", 2, ""))
            VocabularyDatabase.getInstance(context).questionDao().insertQuestion(
                Question("tốn nhiều thời gian, dài dòng?", "time-consuming", "submit", "Arrangement", "come up with", 1, ""))
        }
    }
    fun addDataApply() {
        job = CoroutineScope(Dispatchers.IO + exceptionHandler).launch {
